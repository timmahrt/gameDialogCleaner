...
def cleanChronoTrigger(root):
    ...
    chronoTriggerSrc = join(chronoTriggerRoot, 'src', 'chrono_trigger_japanese_script.txt')
...
def cleanSuperMarioRpg(root):
    ...
    superMarioRpgFilteredSrc = join(superMarioRpgRoot, 'src', 'super_mario_rpg_transcript_ja_new.txt')
